...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form 
    {
        ...
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 1, planning, listeDesAstronautes);
            fenetre.Show();
        }

        private void boutonJour2_Click(object sender, EventArgs e)
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 2, planning, listeDesAstronautes);
            fenetre.Show();
        }

        private void boutonJour3_Click(object sender, EventArgs e)
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 3, planning, listeDesAstronautes);
            fenetre.Show();
        }

        private void boutonJour4_Click(object sender, EventArgs e)
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 4, planning, listeDesAstronautes);
            fenetre.Show();
        }

        private void boutonJour5_Click(object sender, EventArgs e)
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 5, planning, listeDesAstronautes);
            fenetre.Show();
        }

        private void boutonJour6_Click_1(object sender, EventArgs e)
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 6, planning, listeDesAstronautes);
            fenetre.Show();
        }

        private void boutonJour7_Click(object sender, EventArgs e)
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 7, planning, listeDesAstronautes);
            fenetre.Show();
        }

        private void boutonJour8_Click(object sender, EventArgs e)
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 8, planning, listeDesAstronautes);
            fenetre.Show();
        }

        private void boutonJour9_Click(object sender, EventArgs e)
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 9, planning, listeDesAstronautes);
            fenetre.Show();
        }

        private void boutonJour10_Click(object sender, EventArgs e)
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 10, planning, listeDesAstronautes);
            fenetre.Show();
        }

        private void boutonJour11_Click(object sender, EventArgs e)
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 11, planning, listeDesAstronautes);
            fenetre.Show();
        }

        private void boutonJour12_Click(object sender, EventArgs e)
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 12, planning, listeDesAstronautes);
            fenetre.Show();
        }

        private void boutonJour13_Click(object sender, EventArgs e)
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 13, planning, listeDesAstronautes);
            fenetre.Show();
        }

        private void boutonJour14_Click(object sender, EventArgs e)
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 14, planning, listeDesAstronautes);
            fenetre.Show();
        }
        ...
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 15, planning, listeDesAstronautes);
            fenetre.Show();
        }

        private void boutonJour16_Click(object sender, EventArgs e)
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 16, planning, listeDesAstronautes);
            fenetre.Show();
        }

        private void boutonJour17_Click(object sender, EventArgs e)
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 17, planning, listeDesAstronautes);
            fenetre.Show();
        }

        private void boutonJour18_Click(object sender, EventArgs e)
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 18, planning, listeDesAstronautes);
            fenetre.Show();
        }

        private void boutonJour19_Click(object sender, EventArgs e)
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 19, planning, listeDesAstronautes);
            fenetre.Show();
        }

        private void boutonJour20_Click(object sender, EventArgs e)
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 20, planning, listeDesAstronautes);
            fenetre.Show();
        }

        private void boutonJour21_Click(object sender, EventArgs e)
        {
            Form2 fenetre = new Form2(listeJourForm1, jourPivot + 21, planning, listeDesAstronautes);
            fenetre.Show();
        }
